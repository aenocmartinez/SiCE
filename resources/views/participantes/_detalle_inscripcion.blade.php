            ...
            <div class="block-content block-content-full">
                ...
                <table class="table table-borderless fs-sm mb-0">
                    <tbody>
                        ...
                        <tr class="border-top">
                            <td class="fs-md fw-semibold">{{ $formulario->Pagado() ? 'Valor Pagado' : 'Valor Pendiente por Pagar' }}</td>
                            <td class="text-end">
...
<script>
    // Opcional: Si necesitas lógica adicional para la página, puedes agregarla aquí.
</script>
