...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/descargar-recibo-matricula/{participanteId}', [FormularioInscripcionController::class, 'descargarReciboMatricula'])->name('formulario-inscripcion.descargar-recibo-matricula');
